...
* Если FPS мал: в модификаторах меша отключи **Corrective Smooth** для вьюпорта
  (в рендере оставь), включи Scene → Simplify или готовь персонажа с `--work-faces 150000`.
